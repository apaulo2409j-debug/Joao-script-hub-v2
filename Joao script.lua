...
local Window = Fluent:CreateWindow({Title = "👾JoaoScripts👾",SubTitle = "| By:joao",TabWidth = 180,Size = UDim2.fromOffset(660, 440),Acrylic = false,Theme = "Rose",MinimizeKey = Enum.KeyCode.End})
